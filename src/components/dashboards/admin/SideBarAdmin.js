...
import { MdBarChart, MdGroup, MdShield, MdHistory } from "react-icons/md";
...
function SideBarAdmin({ user }) {
  ...
  const links = [
    { href: "/dashboard", label: "Analytics", icon: MdBarChart },
    { href: "/dashboard/users", label: "Users", icon: MdGroup },
    { href: "/dashboard/roles", label: "Roles", icon: MdShield },
    { href: "/dashboard/activities", label: "Activities", icon: MdHistory },
  ];
