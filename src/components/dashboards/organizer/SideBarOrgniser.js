...
function SideBarOrgniser({ user }) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 z-50 flex h-[100dvh] w-72 flex-col border-r border-gray-200 bg-white transition-transform duration-300 md:static md:w-full md:translate-x-0 ${
